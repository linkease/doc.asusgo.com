...
#### 三、支持机型
* 本固件仅支持华硕 ROG魔盒Air（GS7_Air），其它机型请勿使用本固件！

* [点击下载 ROG魔盒Air（GS7_Air）改版固件](https://www.asusgo.com/firmware/download?devicename=gs7_air&firmware=asus_official)
