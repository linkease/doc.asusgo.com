    ...
    <div class="video-moban" v-if="liveDialogVisible">
      <div class="live_box">
        <div class="close1" @click="handleClose()">
          <svg t="1756294680169" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4445" width="20" height="20"><path d="M991.232 17.92c-25.088-24.064-65.024-23.552-89.088 1.536L747.52 179.2 31.232 916.992c-24.064 25.088-23.552 65.024 1.536 89.088 25.088 24.064 65.024 23.552 89.088-1.536L276.992 844.8 992.256 107.008c24.576-25.088 23.552-65.024-1.024-89.088z m14.848 973.312c24.064-25.088 23.552-65.024-1.536-89.088L844.8 747.52 107.008 31.232C81.92 7.168 41.984 7.68 17.92 32.768s-23.552 65.024 1.536 89.088L178.688 276.48l738.304 715.264c25.088 25.088 65.024 24.576 89.088-0.512z" fill="#515151" p-id="4446"></path></svg>
        </div>
